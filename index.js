...
const DataGenerator = require('./lib/data-generator').factory;
const TdgFileExporter = require('./lib/tdg-file-exporter').factory;
...
module.exports.TdgFileExporter = TdgFileExporter;
