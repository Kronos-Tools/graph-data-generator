...
const dataGeneratorFactory = require('../generator/data-generator').factory;
		...
		function execute(vertexName) {
			...
			if (vertexObj.type === 'vertex') {
				...
				if (vertexObj.objects) {
					...
					self.writer.writeObject('vertex_key_data', vertexObj, `${vertexObj.type}_${vertexObj.name}_key_data.json`);
				}
			}
		}
	}
