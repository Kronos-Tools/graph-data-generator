...
// -- timeshift
// ------------------------------------------------
const TdgTimeshiftDispatcher = require('./timeshift/tdg-timeshift-dispatcher').TdgTimeshiftDispatcher;
const tdgTimeshiftDispatcherFactory = require('./timeshift/tdg-timeshift-dispatcher').factory;

module.exports.TdgTimeshiftDispatcher = TdgTimeshiftDispatcher;
module.exports.tdgTimeshiftDispatcherFactory = tdgTimeshiftDispatcherFactory;
