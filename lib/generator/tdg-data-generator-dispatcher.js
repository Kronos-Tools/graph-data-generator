...
class DataGeneratorDispatcher extends llm.LogLevelMixin(_DataGenerator, llm.defaultLogLevels, llm.defaultLogLevels.info) {
...
module.exports.factory = function (options) {
	return new DataGeneratorDispatcher(options);
};

module.exports.dataGeneratorDispatcher = DataGeneratorDispatcher;
